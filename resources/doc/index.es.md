*Descripción*:
Genius Referrals en un intento de mejorar el proceso de integración con sus servicios, ha creado esta biblioteca que le permite a sus clientes, a través de Javascript, consumir los recursos de su RESTful API localizada en http://api.geniusreferrals.com/doc/ . 
...
Descargue la biblioteca compactada utilizando este vínculo https://github.com/GeniusReferrals/GRAPIJavascriptClient/archive/master.zip , descompactela y guardela en un directorio en su proyecto que sea de acceso público, ejemplo: /web  
...
Si necesita más ayuda revise este ejemplo: https://github.com/GeniusReferrals/GRAPIJavascriptClient/blob/master/tests/geniusreferrals-test.html 

*Ejemplos:*  
Hemos implementado varios ejemplos donde se muestra cómo utilizar la biblioteca. Mas detalles aquí https://github.com/GeniusReferrals/GRAPIJavascriptClient/blob/master/tests/geniusreferrals-test.html
